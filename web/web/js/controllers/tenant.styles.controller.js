...
(function () {
    ...
    TenantController.$inject = ['$scope', '$rootScope', 'TenantResource', 'localStorage', '$mdDialog', '$location'];
    /* @ngInject */
    function TenantController($scope, $rootScope, TenantResource, localStorage, $mdDialog, $location) {
        ...
        TenantResource.tenant('').get({
            ...
            if ($scope.style != null && $scope.style.theme != null) {
                ...
                if (theme.includes("pink")) {
                    ...
                    $scope.secondaryColor = "purple";
                }else if (theme.includes("grey")) {
                    $scope.secondaryColor = "grey";
                }
            }
