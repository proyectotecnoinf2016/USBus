...
public class BusTest {
    ...
    public void busesByTenantIdAndStatus() throws Exception {
        Bus bus01 = new Bus(1, "ABC01", "Perro", "0001", 0.1, 5000.0, BusStatus.ACTIVE, true, 44, 200, 12);
        Bus bus02 = new Bus(1, "ABC02", "Perro", "0001", 0.1, 5000.0, BusStatus.ACTIVE, true, 44, 200, 12);
